        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingPhoneNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    ShippingPostalCode = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SellerRequests_AspNetUsers_ReviewedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderGroups_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerOfferId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellerOffers_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_SellerOffers_SellerOfferId",
                        column: x => x.SellerOfferId,
                        principalTable: "SellerOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_SellerOfferId",
                table: "CartItems",
                columns: new[] { "CartId", "SellerOfferId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_SellerOfferId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderGroups_OrderId_SellerId",
                table: "OrderGroups",
                columns: new[] { "OrderId", "SellerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderGroups_SellerId",
                table: "OrderGroups",
                column: "SellerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerOffers_ProductVariantId",
                table: "SellerOffers",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_SellerOffers_SellerId_ProductVariantId",
                table: "SellerOffers",
                columns: new[] { "SellerId", "ProductVariantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SellerRequests_ReviewedByUserId",
